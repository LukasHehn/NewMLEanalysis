...
ion = RooRealVar('ion','E_{ion}',3,15,'keV_{ee}')
rec = RooRealVar('rec','E_{rec}',6,30,'keV_{nr}')
time = RooRealVar('time','time',0,2,'years')
...
# -----------------------------------------------------------------------------------------
# here may be dragons
energy_shift = RooRealVar('energy_shift','energy_shift',-1.0,1.0)
...
#final_gamma_pdf = gamma_bckgd_ion
...
recbins = int((rec.getMax()-rec.getMin())*8)
